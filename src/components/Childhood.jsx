    ...
    <section id="childhood" className="section-container text-center childhood-section">
      <div className="childhood-content">
        ...
        <div className="childhood-photo-container">
          <img src="/we-mini.jpg" alt="Alfarisi and Putri Childhood" className="childhood-photo" />
        ...
        <h2 className="couple-names mt-4 mb-2" style={{ color: '#d85d5d', fontSize: '3.5rem' }}>Alfarisi & Putri</h2>
